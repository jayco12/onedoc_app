    ...
    return (
        <div className="w-4/5 m-auto md:w-1/2">
            <form className=" mt-5 flex md:mt-10">
                ...
                <input type="submit" value="Notify Me" className="bg-Balablue-blue h-14 w-1/3 m-auto p text-white font-Gothic font-extrabold text-xl " placeholder="ENTER YOUR EMAIL"/>
            </form>
